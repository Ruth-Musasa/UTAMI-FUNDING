...
export default function Profil(user) {
    ...
    return (
        <div className="flex gap-10 lg:w-9/12 m-auto pt-20" >
            <div className='w-1/3 m-auto'>
                <div className=" border border-gray-200 ">
                    <div className='relative'>
                        <div className="h-96 w-96 border bg-gray-200  m-auto bg-[url('client/src/assets/profile-pic(4).jpg')] bg-cover rounded-full"></div>
                        <button className="bg-white text-black w-10 h-10 border-[1px] rounded-full shadow-md hover:bg-zinc-800 border-gray-900 text-2xl font-black m-auto absolute bottom-10 right-14 " type="button">+</button>
                    </div>
                    <h2>{user.name} </h2>
                    ...
                    <div className="flex justify-between h-10 text-zinc-500 text-lg ">
                        <Link className='hover:border-b-4 hover:border-b-sky-700 hover:text-[#3563FF] hover:h-10 ' to=''>Mes Projet</Link>
                        <Link className='hover:border-b-4 hover:border-b-sky-700 hover:text-[#3563FF] hover:h-10 ' to='Commentaires'>Commentaires</Link>
                        <Link className='hover:border-b-4 hover:border-b-sky-700 hover:text-[#3563FF] hover:h-10 ' to='Editor'>Poster</Link>
                    </div>
                </div>
