...
export default function Home() {
    return (
        <div className="grid place-content-center ">
            <div className="md:grid md:grid-cols-3 md:pl-20 pb-6 ">
                <div className="m-auto">
                    <h1 className="mt-32 mb-5 text-4xl leading-snug md:text-9xl font-[title] font-black ">UTAMI <br />FUNDING </h1>
                    <p className="text-xl pb-10"> Bienvenue dans notre communauté de créateurs et d'ambitieux, où chaque projet est une histoire en devenir. À travers ce crowdfunding, nous vous invitons à plonger dans un univers d'innovation, de passion et de possibilités infinies.</p>
                    {/* <button className="self-center bg-[#3563FF] rounded-full text-white text-lg font-normal leading-5 py-1.5 px-5 w-36 h-12 left-5 ">Commencer</button> */}
                </div>
                <img className="col-span-2 w-10/12 pt-10 m-auto" src="../src/assets/9689394.jpg" alt="" />
            </div>
            <div className="bg-[#FFDE77] ">
                <div className="mx-8 pb-6 md:w-9/12 md:m-auto md:my-24">
                    <div className=" border-black ">
                        <h2 className=" text-5xl mt-11 mb-7  md:text-6xl">Une plateforme, <br /> des nombreuse possibilité</h2>
                    </div>
            ...
            <div className="flex pb-6 md:w-9/12 md:m-auto md:pt-20 md:pb-36">
                <div className="flex gap-4 h-auto">
                    <div className=" h-[500px] w-44 bg-[url('https://i.pinimg.com/736x/a4/cd/f8/a4cdf8d0a8212bd89b00d69dcb2b01f4.jpg')]  rounded-lg bg-cover"></div>
                    <div className=" h-[500px] w-44 bg-[url('https://i.pinimg.com/736x/d4/71/01/d4710100274f9f9fd965cb5aab435dee.jpg')] mt-20 rounded-lg bg-cover"></div>
                    <div className=" h-[500px] w-44 bg-[url('https://i.pinimg.com/564x/1e/62/b7/1e62b7b3c374c6b15793d3863d165001.jpg')] rounded-lg bg-cover"></div>
                </div>
                <div className="md:px-20 m-auto">
            ...
            <div className=" md:bg-black">
                <div className="text-white px-8 py-6 md:flex md:py-32 md:w-10/12 md:m-auto">
                    <div className="md:border-r mr-10 md:w-1/2">
                    ...
                    <div className="md:grid gap-10 md:grid-cols-2">
                        <div className="w-auto h-auto ">
                            <div className="w-96 h-64  bg-cover bg-[url('client/src/assets/8be8502369c21819b8bb0ad6a8b0afad.jpg')] border-8  border-white rounded-t-lg"></div>
                            <div className="bg-white w-96 h-12 rounded-b-lg text-center text-black text-xl font-black">Projet Architectural</div>
                        </div>
                        <div className="w-auto h-auto ">
                            <div className="w-96 h-64 bg-cover bg-[url('client/src/assets/bd5c4f3b2249a310be4dcf50644cbefe.jpg')] border-8  border-white rounded-t-lg"></div>
                            <div className="bg-white w-96 h-12 rounded-b-lg text-center text-black text-xl font-black">Projet agricole</div>
                        </div><div className="w-auto h-auto ">
                            <div className="w-96 h-64 bg-cover bg-[url('client/src/assets/c53b881e891566634ff68349842b5d7c.jpg')] border-8  border-white rounded-t-lg"></div>
                            <div className="bg-white w-96 h-12 rounded-b-lg text-center text-black text-xl font-black">Projet gastronomique</div>
                        </div><div className="w-auto h-auto ">
                            <div className="w-96 h-64 bg-cover bg-[url('client/src/assets/a80f7343138d26af55ddc65c8ed70383.jpg')] border-8  border-white rounded-t-lg"></div>
                            <div className="bg-white w-96 h-12 rounded-b-lg text-center text-black text-xl font-black">Projet modelisme</div>
                        </div>
                    </div>
                </div>
            </div>
            <div className="px-8 py-20 bg-[#FFF9E9] ">
                <div className="md:w-9/12 md:m-auto md:grid md:grid-cols-3 md:gap-6">
            ...
            <div className="bg-[#f3efe5] text-black px-8 py-6 leading-relaxed md:py-32">
                <h2 className=" text-4xl mt-12 md:w-9/12 md:m-auto md:text-6xl  ">How to create a website for free</h2>
            ...
            <div className="px-8 py-16 text-base md:w-9/12 md:m-auto md:grid md:grid-cols-2 md:gap-20 h-auto">
                ...
                <div>
                    <div className="h-[500px] w-[500px] bg-cover bg-no-repeat bg-[url('https://course.oc-static.com/courses/1946116/1946116_teaser_picture_1680855988.jpg')]"></div>
