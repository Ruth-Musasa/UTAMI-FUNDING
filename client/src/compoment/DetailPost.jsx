        ...
        <div className="pt-20 w-10/12 m-auto lg:flex gap-10">
            ...
            <div className="lg:w-3/12 border">
                ...
                <div className='lg:w-10/12 m-auto'>
                    <h5 className='text-xl md:text-2xl font-black pt-4'>{props.name} Ruth Musasa </h5>
                    <span className="text-lg text-zinc-500 lg:text-xl font-black "> @ {props.user_name} R_Muss</span>
