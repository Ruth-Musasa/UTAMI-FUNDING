        ...
        <div className="pt-20 w-10/12 m-auto lg:flex gap-10">
            <div className="lg:w-9/12">
                ...
                <div className="flex justify-between ">
                    ...
                    <div className='pt-10 pb-4 flex gap-2 ' >
                        ...
                        <p>{post.desired_amount} 100000 $ </p>
                    </div>
                </div>
            ...
            <div className="lg:w-3/12 border">
                ...
                <div className='lg:w-10/12 m-auto'>
                    <h5 className='text-xl md:text-2xl font-black pt-4'>{post.name}  </h5>
                    <span className="text-lg text-zinc-500 lg:text-xl font-black "> @ {post.user_name} </span>
