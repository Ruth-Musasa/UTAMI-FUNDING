                ...
                <div className='space-y-16 py-10 md:border m-auto '>
                    <div className='w-11/12 space-y-2 xl:w-2/3 m-auto'>
                        <form onSubmit={handleSignUp} className="" method='post'>
                            ...
                            <button type="submit" className='w-full text-black hover:text-white rounded-full shadow-md hover:bg-blue-700 border-[1px] border-gray-900 py-2 text-center'>Crée un compte</button>
